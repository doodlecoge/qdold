...
(function($){
    ...
    function AddWidgetEditLink(widget, widgetMenu, settings){
        ...
        if(widget.hasClass(s.options.editable)){
            save = MenuLink(s.i18n.saveText, s.i18n.saveTitle, s.selectors.saveLink);
            save = $(save);
            save.appendTo(widgetMenu);
            save.hide();
            save.click(function(e) {
                var link = $(this);
                var widget = link.parents(s.selectors.widget);
                var edit = widget.find(s.selectors.editLink);
                ...
                if (canSave) {
                    ...
                    edit.html(s.i18n.editText);
                    edit.attr('title', s.i18n.editTitle);
            ...
            $(link).mousedown(function(e){
                e.stopPropagation();
                    ...
                    var widget = link.parents(s.selectors.widget);
                    var save = widget.find(s.selectors.saveLink);
                    var editbox = widget.find(s.selectors.editbox);
                    var content = widget.find(s.selectors.content);
